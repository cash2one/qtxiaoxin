        ...
        <table class="tableForm"> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'summery',array('size'=>35,'maxlength'=>256,'datatype'=>'*1-30','nullmsg'=>'广告摘要不能为空！','errormsg'=>'广告摘要不能超过30个字！')); ?>
                ...
                <tr>
                    <td></td>
                    <td> 
                        <a href="javascript:void(0);" id="sub_from" class="btn btn-primary">保 存</a>
                        <?php //echo CHtml::submitButton($model->isNewRecord ? '创建' : '保存',array('class'=>'btn btn-primary')); ?>
                        <?php if(!$model->isNewRecord){ ?>
                            &nbsp;&nbsp;&nbsp;<a class="btn btn-default" rel="deleLink" href="javascript:void(0);" data-href="<?php echo Yii::app()->createUrl('adv/publicdelete/'.$model->aid);?>">删 除</a>
                        <?php } ?>
