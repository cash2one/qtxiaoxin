    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <table class="tableForm">
            ...
            <tbody>
                ...
                <tr>
                    <td class="td_label">广告标题* ：</td>
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'title',array('size'=>35,'maxlength'=>35,'datatype'=>'*1-15','nullmsg'=>'广告标题不能为空！','errormsg'=>'广告标题不能超过15个字！')); ?>
                 ...
                 <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'summery',array('size'=>35,'maxlength'=>100,'datatype'=>'*1-30','nullmsg'=>'广告摘要不能为空！','errormsg'=>'广告摘要不能超过30个字！')); ?>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'url',array('size'=>30,'maxlength'=>50,'ignore'=>'ignore','datatype'=>'url', 'nullmsg'=>'不能为空！', 'errormsg'=>'请输入正确的链接地址！')); ?>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <?php if(!$model->isNewRecord){ ?>
                           &nbsp;&nbsp;&nbsp;<a class="btn btn-default"  rel="deleLink" href="javascript:void(0);" data-href="<?php echo Yii::app()->createUrl('adv/delete/'.$model->aid);?>">删 除</a>
                        <?php } ?>
