...
<div class="header">
    <div class="headBox fright">
        <div class="headNav">
            ...
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('xiaoxin/notice/noticecenter');?>" class="focus">已收消息</a></li>
                ...
                <ul>
                    <li>
                        ...
                        <div class="txtBox" style="margin-left: 60px;"> 
                            <div class="noticeTitle"><?php echo $val['typedesc'];?> <!-- <?php if($val['noticetype']==6&&$identity!=3):?><a href="<?php echo Yii::app()->createUrl('xiaoxin/class/apply');?>" style="padding: 4px 10px;" class="fright btn btn-raed">处理邀请</a> <?php endif;?>--></div>
                            <div class="infoDetail">来自：<?php echo $val['schoolname']." ".$val['uname'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $val['receivername'];?>&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="timeIco">&nbsp;</span><?php echo $val['showtime'];?>  
                                <!--<span class="commentIco"><a href="javascript:void(0);">评论(<?php //echo (int)$val['replyNum'];?>)</a></span>-->
                            </div>
            ...
            <div class="">
                <div class="commentsBox">
                    ...
                    <div class="textareaBox" style="">
                        ...
                        <textarea rel="textarea" id="textareaText" onkeydown="kbcountInfo(this,'textarea_inputRedinfo');" onkeyup="kbcountInfo(this,'textarea_inputRedinfo');" maxlength="120" style="*width: 99%; *padding:3px 5px; height: 80px;" placeholder="说点什么"></textarea>
                        <div id='textarea_inputRedinfo' class="inputRedinfo">请填写评论,且评论不能大于100个字</div>
                        <div class="commentbtn" style="margin-top: 20px;">&nbsp;
                            <a href="javascript:;" rel="commentRel" msgid="<?php echo $val['msgid'];?>" data-did="<?php echo $val['noticeid'];?>" style="*margin-top:-30px;" class="fright btn btn-default"> 点评 </a>
                    ...
                    <ul class="">
                        ...
                        <li>
                            ...
                            <div class="commentTBox">
                                <div class="commentTxt"><span class="<?php echo ($v['username']?'name':'');?>"><?php echo $v['username']?$v['username']:'匿名人';?></span>说：<?php echo $v['content'];?></div>
    ...
    $(function(){ 
        ...
        $('[rel=commentRel]').click(function(){
            ...
            if(contentS!=""&&contentS.length<=100){
                $.post("/index.php/xiaoxin/notice/reply",{msgid:msgid,content:contentS,noticeId:did,nameless:type},function(data)  //回复评论
                {
