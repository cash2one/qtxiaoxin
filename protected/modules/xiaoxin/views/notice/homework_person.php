...
<div class="mianBox"> 
    <div id="submenuBoxR" class="submenuBoxR" data-viwe="show" >
        ...
        <div class="paneBox" style="background: #FFFFFF;">
            ...
            <div class="box" style="padding: 15px 0;">可以针对班级、分组、学生（个人）发布<?php echo $noticeType==1?"作业信息":"学校通知";?>。 </div>
                ...
                <div class="headNav noticeType_select">
                    <ul>
                        <?php if($noticeType==1):?>
                            ...
                            <li><a avalue="0" href="<?php echo Yii::app()->createUrl("xiaoxin/notice/homework?receiveType=2&noticeType=$noticeType");?>" class="focus"  >学生</a></li>
                        <?php else:?>
                            ...
                            <li><a avalue="0" href="<?php echo Yii::app()->createUrl("xiaoxin/notice/noticefamily?receiveType=2&noticeType=$noticeType");?>" class="focus" >学生</a></li>
                        <?php endif;?>
                    </ul>
                </div>  
            </div>
           ...
           if (val != '') {
                ...
                data: {templatecontent:val,type:0}
                    ...
                    if (data) {
                        if (data.status==1) {
                            $('#msgTip').show();
                            $('#msgTip').animate({opacity: 0}, 3000,function(){
                                 $('#msgTip').hide().css({
                                     'opacity': '1'
                                 });;
                            })   
