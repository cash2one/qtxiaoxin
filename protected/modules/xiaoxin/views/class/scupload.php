        ...
        <div class="box"> 
            ...
            <div class="formBox">
                <div class="classTableBox invtesBox"> 
                    <form id="formBoxRegister" action="<?php echo Yii::app()->createUrl('/xiaoxin/class/scheck/'.$class->cid);?>" method="post">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <div class="danwonInfo">将通讯录按照模板（<a href="<?php echo  Yii::app()->request->baseUrl.'/template'.'/批量邀请学生模版.xls';?>">下载模板</a>）进行整理，保存后上传Excel文件（xls）即可。</div>
...
$(function() {
   //表单验证控件
    ...
    var url = "<?php echo Yii::app()->createUrl('/xiaoxin/class/scheck?cid='.$class->cid);?>&uid="+userid;
    $("#fileExcle").uploadify({ 
        'height'        :'32',
        'width'         :'100',
        'removeTimeout' : 0,
        ...
        'onUploadSuccess':function(file, data, response){ 
            ...
            if(data=='0'){
                ...
                window.location="<?php echo Yii::app()->createUrl('xiaoxin/class/scimport/'.$class->cid);?>";
            }
        }, 
