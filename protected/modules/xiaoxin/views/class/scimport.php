    ...
    <div id="contentBox" class="contentBox">
        <div class="box"> 
            <div class="listTopTite bBottom">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/xiaoxin/class_step_2.png">
            </div> 
            <div class="formBox">
                <div class="classTableBox invtesBox"> 
                    <form id="formBoxRegister" action="<?php echo Yii::app()->createUrl('/xiaoxin/class/scimport/'.$class->cid);?>?ty=import" method="post">
...
<!--                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <p>&nbsp;</p>
                                        <a href="<?php echo Yii::app()->createUrl('xiaoxin/class/scupload?cid='.$class->cid);?>" class="btn btn-default">返回</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="javascript:;" url="<?php echo Yii::app()->createUrl('/xiaoxin/class/scimport/'.$class->cid);?>?ty=import" tip="0" id="postBnt" class="btn btn-raed">下一步</a>
...
<div id="inviteBox" class="popupBox" style=" width: 600px;">
    ...
    <div class="popupBtn">
        <a id="delayPostBtn" href=""  class="btn btn-raed">稍后发送</a>&nbsp;&nbsp;&nbsp;
