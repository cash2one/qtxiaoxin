        ...
        <div class="box"> 
            ...
            <div class="formBox">
                <div class="classTableBox invtesBox"> 
                    <form id="formBoxRegister" action="<?php echo Yii::app()->createUrl('/xiaoxin/class/timport/'.$class->cid);?>?ty=import" method="post">
                            ...
                            <tbody>
                                            ...
                                            <table class="table table-bordered" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $d['error'] ? '<span class="icoBox errorIco">'.($d['msg']?$d['msg']:'手机名字不正确').'</span>' : '<span class="icoBox succesIco"> </span>'; ?>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('xiaoxin/class/tupload?cid='.$class->cid);?>" class="btn btn-default">返回</a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="javascript:;" url="<?php echo Yii::app()->createUrl('/xiaoxin/class/timport/'.$class->cid);?>?ty=import" tip="0" id="postBnt" class="btn btn-raed">下一步</a>
                                        &nbsp;&nbsp;&nbsp;
...
<div id="inviteBox" class="popupBox" style=" width: 600px;">
    <div class="header"><span id="popup_title">发送邀请</span> <a href="<?php echo Yii::app()->createUrl('xiaoxin/class/students/'.$class->cid);?>" class="close"> </a></div>
    ...
    <div class="popupBtn">
        <a id="delayPostBtn" href="<?php echo Yii::app()->createUrl('xiaoxin/class/teachers/'.$class->cid);?>" class="btn btn-raed">稍后发送</a>
    ...
    $('#isPostBnts').click(function(){
        ...
        $.ajax({  
            ...
            success : function(mydata) {
                var data =mydata;  
                 if(data.status=="1"){
                    var urlstr = '<?php echo Yii::app()->createUrl('xiaoxin/class/teachers/'.$class->cid);?>';
