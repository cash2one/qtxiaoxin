		...
		<div class="container" >
			...
			<div class="awards-list">
				...
				<?php foreach($datas as $data): ?>
					...
					<div class="more"> <a href="<?php echo Yii::app()->createUrl('xiaoxin/activity/morelist',array("Userid"=>$userid,"Mgid"=>$data['mgid'])); ?>">更多名单</a></div>
				<?php endforeach; ?>
			...
			<ul class="menu" >
				<li><a href="<?php echo Yii::app()->createUrl('xiaoxin/activity/view',array("Userid"=>$userid)); ?>" >活动</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('xiaoxin/activity/rule',array("Userid"=>$userid)); ?>">规则</a></li>
				<li><a class="active" href="<?php echo Yii::app()->createUrl('xiaoxin/activity/list',array("Userid"=>$userid)); ?>">奖品</a></li>
