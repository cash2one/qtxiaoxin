	...
	<body >
		<div class="container" id="awards">
			...
			<div class="adward-msg">
			 ...
			 <a href="<?php echo Yii::app()->createUrl('xiaoxin/activity/list',array("Userid"=>$userid)); ?>" class="more-msg">更多</a>
			<?php endif; ?>
			...
			<ul class="menu">
				<li><a class="active" href="<?php echo Yii::app()->createUrl('xiaoxin/activity/view',array("Userid"=>$userid)); ?>" >活动</a></li>
				...
				<li><a href="<?php echo Yii::app()->createUrl('xiaoxin/activity/prize',array("Userid"=>$userid)); ?>">我的</a></li>
			</ul>
			<div class="promptBox" id="promptBox">
				...
				<div class="blessing" id="prompt-c">
					...
					<p class="open-awards"><a href="javascript:;" data-isclick="true" data-action="open" data-href="<?php echo Yii::app()->createUrl('xiaoxin/activity/draw'); ?>" id="getOpen">立即打开</a></p>
			...
			<div class="mask"></div>
			<input type="hidden" value="<?php echo Yii::app()->createUrl('xiaoxin/activity/address').'?Userid='.$userid;?>" id="getAddUrl">
